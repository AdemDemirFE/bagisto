...
return [
    ...
    'modules' => [
        ...
        Webkul\CustomAdmin\Providers\ModuleServiceProvider::class,
        Webkul\CustomAI\Providers\ModuleServiceProvider::class,
        Webkul\CustomCheckout\Providers\ModuleServiceProvider::class,
        Webkul\CustomCommerce\Providers\ModuleServiceProvider::class,
        Webkul\CustomCustomer\Providers\ModuleServiceProvider::class,
        Webkul\CustomMarketing\Providers\ModuleServiceProvider::class,
        Webkul\CustomPayments\Providers\ModuleServiceProvider::class,
        Webkul\CustomReports\Providers\ModuleServiceProvider::class,
        Webkul\CustomShipping\Providers\ModuleServiceProvider::class,
