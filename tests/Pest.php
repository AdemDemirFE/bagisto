...
use Webkul\CustomCommerce\Tests\CustomCommerceTestCase;
use Webkul\CustomReports\Tests\CustomReportsTestCase;
use Webkul\CustomPayments\Tests\CustomPaymentsTestCase;
use Webkul\CustomShipping\Tests\CustomShippingTestCase;
use Webkul\CustomCustomer\Tests\CustomCustomerTestCase;
use Webkul\CustomMarketing\Tests\CustomMarketingTestCase;
...
uses(CustomCommerceTestCase::class)->in('../packages/Webkul/CustomCommerce/tests');
uses(CustomReportsTestCase::class)->in('../packages/Webkul/CustomReports/tests');
uses(CustomPaymentsTestCase::class)->in('../packages/Webkul/CustomPayments/tests');
uses(CustomShippingTestCase::class)->in('../packages/Webkul/CustomShipping/tests');
uses(CustomCustomerTestCase::class)->in('../packages/Webkul/CustomCustomer/tests');
uses(CustomMarketingTestCase::class)->in('../packages/Webkul/CustomMarketing/tests');
