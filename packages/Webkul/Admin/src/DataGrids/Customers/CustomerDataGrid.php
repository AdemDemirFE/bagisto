...
class CustomerDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        ...
        $fullNameExpression = DB::getDriverName() === 'pgsql'
            ? '('.$tablePrefix.'customers.first_name || \' \' || '.$tablePrefix.'customers.last_name)'
            : 'CONCAT('.$tablePrefix.'customers.first_name, " ", '.$tablePrefix.'customers.last_name)';
        ...
        if (DB::getDriverName() === 'pgsql') {
            $queryBuilder->groupBy('customer_groups.name');
        }
